      ...
      <div className="relative min-h-screen flex items-center justify-center p-4">
        <div className="relative w-full max-w-6xl bg-white rounded-3xl overflow-hidden animate-slide-up shadow-2xl border border-gray-200">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
            ...
            <div className="relative h-96 lg:h-[600px] bg-gray-100 flex items-center justify-center overflow-hidden p-4">
              <ImageCarousel 
              ...
              {laptop.rating > 0 && (
                <div className="absolute top-6 right-6">
                  <div className="flex items-center space-x-2 bg-white/90 backdrop-blur-sm rounded-full px-3 py-2">
                    ...
                    <span className="text-black font-medium">{laptop.rating}</span>
                    {laptop.reviews > 0 && (
                      <span className="text-gray-600 text-sm">({laptop.reviews})</span>
                    )}
                  </div>
                </div>
              )}
